...
Las cookies son pequeños archivos de texto que se almacenan en tu dispositivo cuando visitás un sitio web. Permiten que el sitio recuerde tus preferencias, mantenga tu sesión activa y mida cómo interactuás con la plataforma.

## 3. Tipos de cookies que usamos

### 3.1 Cookies esenciales (siempre activas)

Estas cookies son estrictamente necesarias para el funcionamiento de la plataforma. No requieren tu consentimiento.

| Cookie | Propósito | Duración |
|---|---|---|
| `pymes_slug` (sessionStorage) | Identifica tu workspace activo | Sesión |
| `pymes_refresh` (sessionStorage) | Mantiene tu sesión segura | Sesión |
| `cf_clearance` | Protección anti-bots de Cloudflare | 30 min |
| `cookie_prefs` (localStorage) | Recuerda tus preferencias de cookies | Persistente |

### 3.2 Cookies de analítica (requieren consentimiento)

Estas cookies nos ayudan a entender cómo se usa la plataforma para mejorarla.

| Proveedor | Cookie | Propósito |
|---|---|---|
| Google Analytics 4 | `_ga`, `_ga_*` | Medición anónima de uso y rendimiento |

Podés aceptar o rechazar estas cookies en cualquier momento desde el banner de configuración.
...
Podés cambiar tus preferencias de cookies en cualquier momento:
