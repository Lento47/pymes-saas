...
const accordionTriggerVariants = cva(
	"group/accordion-trigger relative flex items-start rounded-md border border-transparent text-left outline-none transition-[color,background-color,border-color,box-shadow] focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 focus-visible:after:border-ring disabled:pointer-events-none disabled:opacity-50 **:data-[slot=accordion-trigger-icon]:text-muted-foreground",
	{
		variants: {
