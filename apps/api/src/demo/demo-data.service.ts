    ...
    try {
      ...
      const channelEmail = await this.prisma.channel.create({
        data: {
          ...
          status: "ACTIVE",
          config_json: {
            address: `soporte@${workspaceName.toLowerCase().replace(/\s+/g, "-")}.com`,
          },
        },
      });
      ...
      const contactsData = [
        {
          full_name: "Acme Corp S.A.",
          company_name: "Acme Corp",
          email: "ventas@acmecorp.com",
          phone: "+50622221111",
          type: "CUSTOMER" as const,
          tags: ["vip", "demo"],
        },
        {
          full_name: "Tecnología Digital CR",
          company_name: "Tecnología Digital",
          email: "info@tecdigital.cr",
          phone: "+50633332222",
          type: "CUSTOMER" as const,
          tags: ["tech", "demo"],
        },
        {
          full_name: "Restaurante El Sabor",
          company_name: "El Sabor S.A.",
          email: "admin@elsabor.cr",
          phone: "+50644443333",
          type: "CUSTOMER" as const,
          tags: ["food", "demo"],
        },
        {
          full_name: "Distribuidora Nacional",
          company_name: "Distribuidora Nacional",
          email: "compras@disnacional.cr",
          phone: "+50655554444",
          type: "CUSTOMER" as const,
          tags: ["demo"],
        },
        {
          full_name: "Consultores Asociados",
          company_name: "Consultores Asociados",
          email: "info@consultores.cr",
          phone: "+50666665555",
          type: "LEAD" as const,
          tags: ["lead", "demo"],
        },
        {
          full_name: "Clínica San José",
          company_name: "Clínica San José",
          email: "admin@clinicasj.cr",
          phone: "+50677776666",
          type: "LEAD" as const,
          tags: ["lead", "health", "demo"],
        },
        {
          full_name: "Proveedora Industrial",
          company_name: "Proveedora Industrial S.A.",
          email: "ventas@provindustrial.cr",
          phone: "+50688887777",
        ...
        data: [
          {
            ...
            status: "OPEN",
            notes:
              "Cliente interesado en migrar de Excel a PymesHub. Demo realizada el 15 de abril.",
          },
          {
            workspace_id: workspaceId,
        ...
        data: [
          {
            ...
            direction: "INBOUND",
            sender_name: "Carlos (Tecnología Digital)",
            sender_ref: "tg:+50633332222",
            body_text:
              "Hola, necesito una cotización para desarrollar un e-commerce con carrito de compras. ¿Me pueden ayudar?",
            sent_at: new Date(now2 - 3600000 * 3),
          },
          {
            workspace_id: workspaceId,
            conversation_id: conv1.id,
            direction: "OUTBOUND",
            sender_name: "Equipo PymesHub",
            sender_ref: "agent",
            body_text:
              "¡Claro que sí! ¿Cuántos productos aproximadamente y para qué fecha lo necesitarías?",
            sent_at: new Date(now2 - 3600000 * 2),
          },
          {
            workspace_id: workspaceId,
            conversation_id: conv1.id,
            ...
            sender_name: "Carlos (Tecnología Digital)",
            sender_ref: "tg:+50633332222",
            body_text: "Unos 200 productos. Lo necesito para junio.",
            sent_at: new Date(now2 - 3600000 * 1),
          },
          {
            workspace_id: workspaceId,
            conversation_id: conv1.id,
            ...
            sender_name: "Equipo PymesHub",
            sender_ref: "agent",
            body_text: "Perfecto. Te preparo la cotización hoy mismo y te la envío. ¿A qué correo?",
            sent_at: new Date(now2 - 1800000),
          },
          {
            workspace_id: workspaceId,
            conversation_id: conv1.id,
            ...
            sender_name: "Carlos (Tecnología Digital)",
            sender_ref: "tg:+50633332222",
            body_text: "info@tecdigital.cr ¡Gracias!",
            sent_at: new Date(now2 - 900000),
          },
        ],
      });
        ...
        data: [
          {
            ...
            direction: "INBOUND",
            sender_name: "Administración El Sabor",
            sender_ref: "admin@elsabor.cr",
            body_text:
              "Hola, la factura DEMO-003 tiene un error en el monto del IVA. ¿Pueden revisarla?",
            sent_at: new Date(now2 - 7200000),
          },
          {
            workspace_id: workspaceId,
            conversation_id: conv2.id,
            ...
            sender_name: "Equipo PymesHub",
            sender_ref: "agent",
            body_text: "Revisamos de inmediato y te confirmamos.",
            sent_at: new Date(now2 - 3600000),
          },
          {
            workspace_id: workspaceId,
            conversation_id: conv2.id,
            ...
            sender_name: "Administración El Sabor",
            sender_ref: "admin@elsabor.cr",
            body_text: "Gracias, quedo atenta.",
            sent_at: new Date(now2 - 1800000),
          },
        ],
      });
        ...
        data: [
          {
            ...
            description:
              "Asigna automáticamente conversaciones urgentes de WhatsApp al dueño del workspace",
          ...
          },
          {
            ...
            action_config_json: {
              ...
              body: "Se ha creado una nueva conversación en tu inbox",
            },
            enabled: true,
          },
        ],
      ...
      await this.prisma.task.createMany({
        data: [
          {
            workspace_id: workspaceId,
            title: "Revisar cotización de Tecnología Digital",
            description:
              "Preparar cotización para e-commerce con 200 productos. Fecha límite: hoy.",
            status: "IN_PROGRESS",
            priority: "HIGH",
            due_at: new Date(now.getTime() + 86400000),
            source: "MANUAL",
          },
          {
            workspace_id: workspaceId,
            title: "Llamar a Clínica San José",
            description: "Seguimiento de lead. Contactar a administración.",
            status: "TODO",
            priority: "MEDIUM",
            due_at: new Date(now.getTime() + 2 * 86400000),
            source: "MANUAL",
          },
          {
            workspace_id: workspaceId,
            title: "Actualizar datos de Acme Corp",
            description:
              "Verificar dirección y teléfono actualizados para facturación electrónica.",
            status: "TODO",
            priority: "LOW",
            source: "MANUAL",
          },
          {
            workspace_id: workspaceId,
            title: "Corregir factura DEMO-003",
            description:
              "Revisar error de IVA reportado por Restaurante El Sabor. Corregir y reenviar.",
            status: "TODO",
            priority: "HIGH",
            due_at: new Date(now.getTime() + 86400000),
            source: "MANUAL",
      ...
      this.logger.log(
        `Demo data populated for workspace ${workspaceId}: 8 contacts, 4 invoices, 2 deals, 2 conversations, 3 automations, 4 tasks`,
      );
    } catch (err) {
      this.logger.error(
        `Failed to populate demo data for workspace ${workspaceId}: ${(err as Error).message}`,
      );
    }
  }
