...
export class InventoryController {
  ...
  getMovements(
    ...
    return this.inventory.getMovements(workspaceId, productId, page ? +page : 1, limit ? +limit : 50);
  }
  ...
  @Post('categories')
  @Roles(WorkspaceUserRole.ADMIN)
  createCategory(@CurrentUser('workspace_id') workspaceId: string, @Body() body: { name: string; description?: string; color?: string }) {
