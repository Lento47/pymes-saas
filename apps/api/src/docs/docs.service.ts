  ...
  private readonly docs: DocEntry[] = [
    {
      ...
      summary:
        "PymesHub es una plataforma de customer operations que unifica conversaciones omnicanal, facturación, pipeline de ventas, gestión documental, automatizaciones y gobernanza de workspace.",
      sections: [
    ...
    },
    {
      ...
      category: "operations",
      summary:
        "Guía paso a paso para activar un workspace con roles, canales, departamentos y documentación.",
      sections: [
    ...
    },
    {
      ...
      category: "security",
      summary:
        "Material de confianza, seguridad y cumplimiento para procurement, IT, seguridad y compliance.",
      sections: [
    ...
    },
    {
      ...
      category: "legal",
      summary:
        "Reglas de acceso, uso, licencia, pagos, suspensión, responsabilidad y ley aplicable.",
      sections: [
    ...
    },
    {
      ...
      category: "legal",
      summary:
        "Ciclos de cobro, renovación, impuestos, cancelación, downgrade y política de reembolsos.",
      sections: [
    ...
    },
    {
      ...
      category: "legal",
      summary:
        "Reglas de uso de WhatsApp, Telegram, correo electrónico, Signal (próximamente) y funcionalidades asistidas por inteligencia artificial.",
      sections: [
    ...
    },
    {
      ...
      category: "legal",
      summary:
        "Tipos de cookies utilizadas, finalidad, duración y mecanismos de gestión del consentimiento.",
      sections: [
    ...
    },
    {
      ...
      category: "legal",
      summary:
        "Reglas vinculantes cuando el cliente es responsable y PymesHub actúa como encargado del tratamiento.",
      sections: [
    ...
    for (const doc of this.docs) {
      ...
      for (const section of doc.sections) {
        if (section.toLowerCase().includes(q)) {
          ...
          bestSnippet =
            (start > 0 ? "…" : "") + section.slice(start, end) + (end < section.length ? "…" : "");
        }
      }
