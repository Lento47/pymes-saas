...
export class PipelineController {
  ...
  async createStage(@CurrentUser("workspace_id") workspaceId: string, @Body() dto: CreateStageDto) {
  ...
  @RequireFeature("pipeline")
  async createDeal(@CurrentUser("workspace_id") workspaceId: string, @Body() dto: CreateDealDto) {
    await this.planLimits.enforcePlanTier(workspaceId, "STARTER", "Pipeline");
