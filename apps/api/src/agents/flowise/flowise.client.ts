...
Responde SOLO con JSON: {"intent": "...", "summary": "una línea"}` }],
  ...
  buildTier2FlowData(model: FlowiseModelConfig, toolIdMap?: Record<string, string>): string {
    const tid = (n: string) => toolIdMap?.[n] ?? n;
    const m = { ...model, temperature: model.temperature ?? 0.3 };
    const fast = { ...m, temperature: 0.1 };
...
Responde SOLO con JSON: {"safe": true} o {"safe": false, "risk": "..."}` }],
    ...
    const toolPlan = FlowiseClient.buildToolNode({ id: "toolAgentflow_0", label: "get_workspace_plan", toolId: tid("get_workspace_plan"), inputValue: "{}", position: { x: 1000, y: 400 }, updateState: JSON.stringify([{ key: "workspacePlan", value: "{{ toolAgentflow_0.output }}" }]) });
    const toolCtx = FlowiseClient.buildToolNode({ id: "toolAgentflow_1", label: "get_workspace_context", toolId: tid("get_workspace_context"), inputValue: "{}", position: { x: 1250, y: 400 }, updateState: JSON.stringify([{ key: "workspaceContext", value: "{{ toolAgentflow_1.output }}" }]) });
    ...
    // WhatsApp branch
    const toolCh = FlowiseClient.buildToolNode({ id: "toolAgentflow_2", label: "get_channel_status", toolId: tid("get_channel_status"), inputValue: '{"type":"WHATSAPP"}', position: { x: 2000, y: 100 }, updateState: JSON.stringify([{ key: "channelStatus", value: "{{ toolAgentflow_2.output }}" }]) });
    ...
    // Telegram branch
    const toolTg = FlowiseClient.buildToolNode({ id: "toolAgentflow_4", label: "get_channel_status", toolId: tid("get_channel_status"), inputValue: '{"type":"TELEGRAM"}', position: { x: 2000, y: 250 }, updateState: JSON.stringify([{ key: "channelStatus", value: "{{ toolAgentflow_4.output }}" }]) });
    ...
    // CRM/Workflow branch
    const toolWf = FlowiseClient.buildToolNode({ id: "toolAgentflow_5", label: "get_workflow_config", toolId: tid("get_workflow_config"), inputValue: "{}", position: { x: 2000, y: 400 }, updateState: JSON.stringify([{ key: "workflowStatus", value: "{{ toolAgentflow_5.output }}" }]) });
    ...
    // Billing branch
    const toolBill = FlowiseClient.buildToolNode({ id: "toolAgentflow_6", label: "get_billing_status", toolId: tid("get_billing_status"), inputValue: "{}", position: { x: 2000, y: 550 }, updateState: JSON.stringify([{ key: "billingStatus", value: "{{ toolAgentflow_6.output }}" }]) });
...
Responde SOLO con JSON: {"escalate": true/false, "reason": "..."}` }],
  ...
  buildTier3FlowData(model: FlowiseModelConfig, toolIdMap?: Record<string, string>): string {
    ...
    const toolCh = FlowiseClient.buildToolNode({ id: "toolAgentflow_2", label: "get_channel_status", toolId: tid("get_channel_status"), inputValue: "{}", position: { x: 1750, y: 250 }, updateState: JSON.stringify([{ key: "channelStatus", value: "{{ toolAgentflow_2.output }}" }]) });
    ...
    const toolWf = FlowiseClient.buildToolNode({ id: "toolAgentflow_4", label: "get_workflow_config", toolId: tid("get_workflow_config"), inputValue: "{}", position: { x: 1750, y: 450 }, updateState: JSON.stringify([{ key: "workflowStatus", value: "{{ toolAgentflow_4.output }}" }]) });
    ...
    // Billing branch
    const toolBill = FlowiseClient.buildToolNode({ id: "toolAgentflow_5", label: "get_billing_status", toolId: tid("get_billing_status"), inputValue: "{}", position: { x: 1750, y: 600 }, updateState: JSON.stringify([{ key: "billingStatus", value: "{{ toolAgentflow_5.output }}" }]) });
    ...
    const toolErrors = FlowiseClient.buildToolNode({ id: "toolAgentflow_6", label: "get_recent_errors", toolId: tid("get_recent_errors"), inputValue: '{"limit":20}', position: { x: 1750, y: 800 }, updateState: JSON.stringify([{ key: "errorReportsSummary", value: "{{ toolAgentflow_6.output }}" }]) });
    const toolLogs = FlowiseClient.buildToolNode({ id: "toolAgentflow_7", label: "get_railway_logs", toolId: tid("get_railway_logs"), inputValue: '{"limit":50}', position: { x: 2000, y: 800 }, updateState: JSON.stringify([{ key: "logsSummary", value: "{{ toolAgentflow_7.output }}" }]) });
    const toolCommits = FlowiseClient.buildToolNode({ id: "toolAgentflow_8", label: "get_recent_commits", toolId: tid("get_recent_commits"), inputValue: '{"limit":10}', position: { x: 2250, y: 800 } });
    ...
    // Code reading path
    const toolSearch = FlowiseClient.buildToolNode({ id: "toolAgentflow_9", label: "search_github_files", toolId: tid("search_github_files"), inputValue: '{"query":"{{ $flow.state.codeEvidence }}","limit":5}', position: { x: 3000, y: 700 }, updateState: JSON.stringify([{ key: "targetFilePath", value: "{{ toolAgentflow_9.output }}" }]) });
    const toolReadFile = FlowiseClient.buildToolNode({ id: "toolAgentflow_10", label: "read_github_file", toolId: tid("read_github_file"), inputValue: '{"path":"{{ $flow.state.targetFilePath }}"}', position: { x: 3250, y: 700 }, updateState: JSON.stringify([{ key: "codeEvidence", value: "{{ toolAgentflow_10.output }}" }]) });
    ...
    const toolCreateFix = FlowiseClient.buildToolNode({ id: "toolAgentflow_11", label: "create_fix_proposal", toolId: tid("create_fix_proposal"), inputValue: "{{ $flow.state.fixProposal }}", position: { x: 3500, y: 900 } });
...
Responde SOLO con JSON: {"classification": "safe|injection|sensitive_data|abuse", "risk": "none|low|medium|high", "reason": "..."}` }],
    ...
    // Workspace context
    const toolPlan = FlowiseClient.buildToolNode({ id: "toolAgentflow_0", label: "get_workspace_plan", toolId: tid("get_workspace_plan"), inputValue: "{}", position: { x: 1000, y: 450 }, updateState: JSON.stringify([{ key: "workspacePlan", value: "{{ toolAgentflow_0.output }}" }]) });
    const toolCtx = FlowiseClient.buildToolNode({ id: "toolAgentflow_1", label: "get_workspace_context", toolId: tid("get_workspace_context"), inputValue: "{}", position: { x: 1250, y: 450 }, updateState: JSON.stringify([{ key: "workspaceContext", value: "{{ toolAgentflow_1.output }}" }]) });
    ...
    // Channel incident
    const toolCh = FlowiseClient.buildToolNode({ id: "toolAgentflow_2", label: "get_channel_status", toolId: tid("get_channel_status"), inputValue: "{}", position: { x: 1750, y: 350 }, updateState: JSON.stringify([{ key: "channelStatus", value: "{{ toolAgentflow_2.output }}" }]) });
    const toolChanErrors = FlowiseClient.buildToolNode({ id: "toolAgentflow_4", label: "get_recent_errors (channel)", toolId: tid("get_recent_errors"), inputValue: '{"limit":20}', position: { x: 2000, y: 350 }, updateState: JSON.stringify([{ key: "errorReportsSummary", value: "{{ toolAgentflow_4.output }}" }]) });
    ...
    const toolErrors = FlowiseClient.buildToolNode({ id: "toolAgentflow_5", label: "get_recent_errors", toolId: tid("get_recent_errors"), inputValue: '{"limit":30}', position: { x: 1750, y: 600 }, updateState: JSON.stringify([{ key: "errorReportsSummary", value: "{{ toolAgentflow_5.output }}" }]) });
    const toolLogs = FlowiseClient.buildToolNode({ id: "toolAgentflow_6", label: "get_railway_logs", toolId: tid("get_railway_logs"), inputValue: '{"limit":100}', position: { x: 2000, y: 600 }, updateState: JSON.stringify([{ key: "logsSummary", value: "{{ toolAgentflow_6.output }}" }]) });
    const toolCommits = FlowiseClient.buildToolNode({ id: "toolAgentflow_7", label: "get_recent_commits", toolId: tid("get_recent_commits"), inputValue: '{"limit":10}', position: { x: 2250, y: 600 } });
    const toolSearch = FlowiseClient.buildToolNode({ id: "toolAgentflow_8", label: "search_github_files", toolId: tid("search_github_files"), inputValue: '{"query":"{{ $flow.state.inputSanitized }}","limit":5}', position: { x: 2500, y: 600 }, updateState: JSON.stringify([{ key: "targetFilePath", value: "{{ toolAgentflow_8.output }}" }]) });
    const toolReadFile = FlowiseClient.buildToolNode({ id: "toolAgentflow_9", label: "read_github_file", toolId: tid("read_github_file"), inputValue: '{"path":"{{ $flow.state.targetFilePath }}"}', position: { x: 2750, y: 600 }, updateState: JSON.stringify([{ key: "codeEvidence", value: "{{ toolAgentflow_9.output }}" }]) });
    const llmRootCause = FlowiseClient.buildLLMNode({
...
Responde JSON: {"security_ok": true/false, "risk_areas": [...], "requires_human": true/false}` }],
    ...
    const toolCreateFix = FlowiseClient.buildToolNode({ id: "toolAgentflow_10", label: "create_fix_proposal", toolId: tid("create_fix_proposal"), inputValue: "{{ $flow.state.fixProposal }}", position: { x: 4000, y: 700 } });
...
Responde JSON: {"pr_eligible": true/false, "reason": "...", "branch_name": "fix/auto-...", "pr_title": "...", "pr_body": "..."}` }],
    ...
    const toolCreatePR = FlowiseClient.buildToolNode({ id: "toolAgentflow_11", label: "create_github_pr", toolId: tid("create_github_pr"), inputValue: "{{ $flow.state.prDraft }}", position: { x: 5000, y: 600 }, updateState: JSON.stringify([{ key: "finalResponse", value: "{{ toolAgentflow_11.output }}" }]) });

    // Billing branch
    const toolBill = FlowiseClient.buildToolNode({ id: "toolAgentflow_12", label: "get_billing_status", toolId: tid("get_billing_status"), inputValue: "{}", position: { x: 1750, y: 850 }, updateState: JSON.stringify([{ key: "billingStatus", value: "{{ toolAgentflow_12.output }}" }]) });
    ...
    // Security incident
    const toolSecErrors = FlowiseClient.buildToolNode({ id: "toolAgentflow_13", label: "get_recent_errors (security)", toolId: tid("get_recent_errors"), inputValue: '{"limit":50}', position: { x: 1750, y: 1050 } });
    const toolSecLogs = FlowiseClient.buildToolNode({ id: "toolAgentflow_14", label: "get_railway_logs (security)", toolId: tid("get_railway_logs"), inputValue: '{"limit":200}', position: { x: 2000, y: 1050 } });
