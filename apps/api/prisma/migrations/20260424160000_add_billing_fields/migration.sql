...
-- plan already exists from init migration; use IF NOT EXISTS to be idempotent
...
-- status/trial_ends_at/current_period_* already exist from add_billing_foundation; IF NOT EXISTS guards
