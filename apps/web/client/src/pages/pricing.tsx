  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="px-4 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl text-center">
          <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl">
            Simple plans to organize your business
          </h1>
          <p className="mt-4 text-xl text-gray-600">
            Manage customers, invoices, sales, follow-ups, and automations from one connected
            workspace.
          </p>
        </div>
      </section>
      ...
      <section className="bg-blue-600 px-4 py-16 text-center text-white sm:px-6 lg:px-8">
        <h2 className="mb-4 text-3xl font-bold">Ready to start with Growth?</h2>
        <p className="mb-8 text-lg opacity-90">
          Join businesses that are organizing their operations with PymeHub.
        </p>
