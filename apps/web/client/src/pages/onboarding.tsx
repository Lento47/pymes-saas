  ...
  return (
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        <div className={cn("text-[13px] font-medium", selected ? "text-foreground" : "text-foreground")}>{label}</div>
  ...
  return (
    <div className="flex min-h-screen items-start justify-center bg-canvas px-6 py-10">
      <div className="w-full max-w-[520px]">
        ...
        <p className="mb-5 text-[13px] text-muted-foreground">{stepSubs[step]}</p>
