            ...
            <div className="glass-panel mt-8 rounded-[34px] px-7 py-8 md:px-10 md:py-10">
              ...
              {markdown ? (
                <div className="mt-8
                  ...
                  prose-table:text-white/80 prose-th:text-white/80 prose-th:font-semibold prose-td:border-white/[0.06] prose-th:border-white/[0.06]
                ...
                <div className="mt-10 space-y-8">
                  <section className="space-y-3">
                    ...
                    <p className="text-sm leading-7 text-white/75">{doc.purpose}</p>
                  </section>
                  ...
                  <section className="space-y-3">
                    ...
                    <ul className="space-y-3">
                      {doc.highlights.map((item) => (
                        <li
                          key={item}
                          className="glass-panel-soft rounded-[22px] px-4 py-4 text-sm leading-7 text-white/80"
                        >
                          {item}
                        </li>
                      ))}
