...
export const translations = {
  en: {
    ...
    dashboard: {
      ...
      subtitle: "Here's what matters most for your business today.",
      ...
      bannerFallbackTitle: "Everything looks good today",
      bannerFallbackSubtitle: "Your business is on track. Keep going! ✨",
      insightNoAlerts: "No urgent alerts",
      insightNoAlertsDesc: "Great! Everything is under control.",
      insightAlertsInvoices: "invoices overdue",
      insightAlertsDesc: "Total amount pending review.",
      insightFollowUp: "Best time to follow up",
      insightFollowUpDesc: "Based on contact engagement patterns.",
    ...
    inbox: {
      ...
      channel: "Channel",
      selectActiveChannel: "Select an active channel",
  ...
  es: {
    ...
    inbox: {
      ...
      channel: "Canal",
      selectActiveChannel: "Seleccioná un canal activo",
    ...
    register: {
      title: "Crear cuenta",
      subtitle: "Configurá tu workspace y empezá a gestionar tu negocio.",
      ...
      checkDetails: "Verificá tus datos.",
      lengthRule: "Al menos 8 caracteres",
      uppercaseRule: "Una mayúscula",
      lowercaseRule: "Una minúscula",
