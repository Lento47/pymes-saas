...
export const translations = {
  en: {
    ...
    landing: {
      ...
      intro: "PymesHub · pymeshub.lat",
      title: ["CRM, conversations, invoicing", "and workflows for growing SMBs."],
      subtitle: "Centralize WhatsApp, email, clients, tasks, and operations in one platform.",
      description:
        "PymesHub is the operating system for growing SMBs that need a WhatsApp CRM, shared inbox, client management, workflow automation, and invoicing follow-through without stitching tools together.",
      ...
      seoHub: {
        ...
        description:
          "Go deeper into the customer operations jobs PymesHub supports: WhatsApp CRM, shared inbox, client management, invoicing, and workflow automation for growing teams.",
        links: [
  ...
  es: {
    ...
    landing: {
      ...
      intro: "PymesHub · pymeshub.lat",
      title: ["CRM, conversaciones, facturación", "y workflows para pymes en crecimiento."],
      subtitle: "Centraliza WhatsApp, correo, clientes, tareas y operaciones en una sola plataforma.",
      description:
        "PymesHub es el sistema operativo para pymes en crecimiento que necesitan WhatsApp CRM, bandeja compartida, gestión de clientes, automatización de workflows y seguimiento de facturación sin pegar herramientas sueltas.",
      ...
      seoHub: {
        eyebrow: "Explora casos de uso",
        title: "Construido para los flujos SMB que tus compradores sí buscan.",
        description:
          "Profundiza en los trabajos de customer operations que PymesHub soporta: WhatsApp CRM, bandeja compartida, gestión de clientes, facturación y automatización de workflows para equipos en crecimiento.",
        links: [
          { href: "/whatsapp-shared-inbox", label: "WhatsApp shared inbox" },
          { href: "/crm-for-smbs", label: "CRM para pymes" },
          { href: "/client-management", label: "Gestión de clientes" },
          { href: "/workflow-automation", label: "Automatización de workflows" },
          { href: "/whatsapp-crm", label: "WhatsApp CRM" },
