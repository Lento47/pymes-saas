...
- fuerza mayor;
- eventos generalizados de terceros;
- configuraciones defectuosas del cliente;
- uso prohibido o abusivo del servicio.

## 4. Mantenimiento programado

Los mantenimientos relevantes deben anunciarse con anticipacion razonable cuando puedan afectar el servicio de forma perceptible. Debe procurarse que ocurran en ventanas de menor impacto.

## 5. Incidentes severos

Los incidentes `P1` o `SEV-1` deben tratarse con:

- activacion prioritaria;
- contencion inmediata razonable;
- coordinacion tecnica;
- comunicacion a clientes impactados cuando corresponda.

## 6. Creditos

Salvo pacto enterprise expreso, este SLA funciona como objetivo operativo. Si en el futuro se ofrecen creditos, deberan definirse:
