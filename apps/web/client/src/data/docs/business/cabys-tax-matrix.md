...
- Ninguna nueva linea comercial debe venderse sin incorporarse antes a esta matriz.
- El CAByS y el IVA aqui consignados son de trabajo hasta validacion final del contador.
- El texto de la columna `Concepto facturable` debe coincidir con el usado en factura o en su plantilla aprobada.
- Toda actualizacion debe dejar fecha y responsable.
...
Cada fila validada deberia poder vincularse a:

- criterio del contador;
- fecha de validacion;
- texto aprobado de factura;
- politica comercial o servicio al que corresponde.
