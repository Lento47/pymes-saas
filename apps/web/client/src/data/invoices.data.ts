export const STATUS_OPTIONS = ["ALL", "DRAFT", "SENT", "PARTIALLY_PAID", "PAID", "OVERDUE", "CANCELLED"];
export const HACIENDA_STATUS_OPTIONS = ["ALL", "DRAFT", "PENDING_SUBMISSION", "SUBMITTED", "RECIBIDO", "PROCESANDO", "ACEPTADO", "RECHAZADO", "ERROR"];
export const DOCUMENT_TYPES = ["FACTURA_ELECTRONICA", "TIQUETE_ELECTRONICO", "NOTA_CREDITO", "NOTA_DEBITO", "MENSAJE_RECEPTOR"];
export const ISSUANCE_MODES = ["MANUAL_ONLY", "HACIENDA"];
